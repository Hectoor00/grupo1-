<?php 
    ...
    if(isset($_GET['like']))
    {
        ...
        $queryLike = "SELECT * FROM productos WHERE codproducto LIKE '%$valor%' OR producto LIKE '%$valor%'";

        $dataUser = CRUD($queryLike,"s");
    }
    else{
        $dataUser = CRUD("SELECT * FROM productos ORDER BY idproducto LIMIT $inicio,$registros", "s");
...
?>
    ...
    <div style="margin-bottom: 10px;">
        <div class="row">
            <div class="col-md-2">
                <a href="" class="btn btn-success new-producto"><i class="fas fa-plus"></i></a>
            </div>
            <div class="col-md-4">
