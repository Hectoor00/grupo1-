...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-secondary text-white" >
    <a class="navbar-brand" href="#">PAW 2021</a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link product" href="#">Productos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link categorias" href="#">Categorias</a>
        </li>
        <li class="nav-item">
          <a class="nav-link proveedores" href="#">Proveedores</a>
        </li>
        <li class="nav-item">
          <a class="nav-link inventario" href="#">Inventario</a>
        </li>
      </ul>
